...
function afficherSectionEtagere(contenuPrincipalElement) {
    ...
    if (menuEtagereListElement) {
        menuEtagereListElement.innerHTML = ""; // Effacer la liste des étagères précédente (si elle existait)
        ...
        etageresExemples.forEach(etagere => {
            ...
            menuEtagereListElement.appendChild(carteHTML); // Ajouter la carte HTML à la liste (ul) du menu
        });
    } else {
...
// Pas besoin d'exporter avec CDN
// export { afficherSectionEtagere };
